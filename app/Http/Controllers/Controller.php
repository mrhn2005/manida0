...
class Controller extends BaseController
{
    ...
    {   
        ...
        $products=Product::orderBy('id','desc')->with(['category.translations','translations','images'])->get();
        ...
        $content=Content::where('locale',$locale)->firstOrFail();
        // return view('first.home');
        $banners=Banner::all();
        return view('first.home',compact('content','banners','products','categories'));
    }
