                ...
                <div class="row">
                   <div class="col-md-12">
                    ...
                    <h1 class="page-header" style="margin-right:10px;">
                      ویرایش محصول
                      <!--<img style="float:left" height="80" src="{{$category->photo ? '/photos/'.$category->photo->name : 'http://placehold.it/400x400' }} "-->
                    </h1>
                       
                    </div>
                    <form action="{{route('categories.update',$category)}}" method="post" enctype="multipart/form-data" style="color:black;">
